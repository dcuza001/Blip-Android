...
public class MapActivity extends FragmentActivity implements GeoQueryEventListener, GoogleMap.OnCameraChangeListener, LocationListener {
    ...
    /**
     * Creates the geolocation, circle, color of circle, starting location,
     * and retrieves all the markers in the initial circle
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GeoLocation INITIAL_CENTER = new GeoLocation(latitude, longitude);

        //create the circle
        LatLng latLngCenter = new LatLng(INITIAL_CENTER.latitude, INITIAL_CENTER.longitude);
        this.searchCircle = this.map.addCircle(new CircleOptions().center(latLngCenter).radius(radiusValue));
        ...
        map.moveCamera( CameraUpdateFactory.newLatLngZoom(new LatLng(latitude,longitude) , INITIAL_ZOOM_LEVEL) );
        ...
        //speed of updates right now at 1 for testing
    ...
    /**
     * Keeping in a function in case we need a secondary search radius
